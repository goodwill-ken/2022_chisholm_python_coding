...
# use if else function. Now with inputs rather than 600.


headphones_cost1 = 20
number_ordered = int(input('How many pairs of headphones would you like to order?  '))
...
if number_ordered > 500:
    ...
    print('the total cost of ', number_ordered, 'headphones without a discount is: ', '$', total_cost)
